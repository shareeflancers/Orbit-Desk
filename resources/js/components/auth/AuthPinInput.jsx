...
/**
 * AuthPinInput — A 6-digit OTP/Verification code input composed of 6 separate boxes.
 * Auto-advances focus and handles pasting a full 6-digit code.
 */
export default function AuthPinInput({ length = 6, onComplete }) {
        ...
        <div className="flex items-center gap-2 sm:gap-3 justify-center w-full" onPaste={handlePaste}>
            {values.map((v, idx) => (
                <input
                    ...
                    className="
                        w-12 h-14 sm:w-14 sm:h-16 text-center text-xl sm:text-2xl font-bold rounded-2xl bg-gray-50 border border-gray-200 text-gray-900
                        transition-all duration-200 focus:outline-none focus:bg-white focus:border-indigo-600 focus:ring-4 focus:ring-indigo-600 focus:ring-opacity-20 hover:bg-gray-100
                    "
