...
/**
 * ThemedPasswordInput — Handles password visibility toggle and real-time strength validation.
 */
        ...
        <div className={`flex flex-col gap-1.5 ${className}`}>
            ...
            <div className="relative">
                <input
                    ...
                    className={`
                        ...
                        ${error
                            ...
                            : 'border-transparent focus:border-[var(--od-primary)] focus:ring-[var(--od-primary)] hover:bg-gray-100'}
                    `}
                    {...props}
                />
                ...
                <button
                    ...
                    className="absolute inset-y-0 right-0 flex items-center pr-4 text-gray-400 hover:text-gray-600 focus:outline-none focus:text-[var(--od-primary)]"
                    tabIndex={-1}
                >
